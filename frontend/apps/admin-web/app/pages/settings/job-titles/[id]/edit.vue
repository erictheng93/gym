...
const { getJobTitle, updateJobTitle } = useJobTitles()

const jobTitleId = computed(() => route.params.id as string)
...
const handleSubmit = async () => {
  ...
  try {
    await updateJobTitle(jobTitleId.value, {
      name: form.name,
  ...
  <div class="form-page">
    ...
    <template v-else>
      ...
      <div class="form-hero">
        ...
        <h1 class="text-headline">編輯職位</h1>
        <p class="text-body text-secondary">修改職位名稱與權限設定</p>
      </div>
