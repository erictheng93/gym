/**
 * Branding SSR Plugin for Admin Web
 *
...
export default defineNitroPlugin((nitroApp) => {
  nitroApp.hooks.hook('render:html', async (html, { event }) => {
    ...
    // In production, this could be derived from the hostname
    ...
    const criticalCSS = generateAppCriticalCSS(branding, 'admin');

    // Find and replace the hardcoded critical CSS, or inject new one
    // The existing style tag with Launch Screen CSS will be replaced
