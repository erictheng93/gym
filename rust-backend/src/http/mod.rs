...
pub fn router(state: AppState) -> Router {
    Router::new()
        ...
        .route("/api/bookings/{id}/cancel", post(class_scheduling::cancel_booking_action))
        .route("/api/bookings/{id}/attend", post(class_scheduling::attend_booking_action))
        .route(
            "/api/bookings/{id}",
        ...
        .route("/api/reports/revenue/export", get(dashboard_reports::revenue_export))
        .route("/api/reports/member-growth", get(dashboard_reports::member_growth_report))
        .route("/api/reports/member-growth/export", get(dashboard_reports::member_growth_export))
        .route("/api/reports/contract-expiry", get(dashboard_reports::contract_expiry_report))
        .route("/api/reports/contract-expiry/export", get(dashboard_reports::contract_expiry_export))
